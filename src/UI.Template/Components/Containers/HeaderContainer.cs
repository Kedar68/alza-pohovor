...
public class HeaderContainer : BaseComponent
{
    ...
    private readonly Simple BasketContainer = new(By.XPath("//div[@class='cart-items']"));
    ...
    private readonly Simple CheckoutButton = new(By.XPath("//button[@class='checkout-button']"));
